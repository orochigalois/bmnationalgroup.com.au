...
if ( !function_exists( 'ureach_woocommerce_get_css' ) ) {
	add_filter( 'ureach_filter_get_css', 'ureach_woocommerce_get_css', 10, 4 );
	function ureach_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.woocommerce .sidebar_inner span.amount, .woocommerce-page .sidebar_inner span.amount {
	color: {$colors['text_link']};
}
...
/* Buttons */
.ureach_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.ureach_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
