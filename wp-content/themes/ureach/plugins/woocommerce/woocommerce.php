		...
		if (ureach_exists_woocommerce()) {
			...
			ureach_storage_merge_array('options', '', array(
				...
				'related_posts_shop' => array(
					"title" => esc_html__('Related products', 'ureach'),
					"desc" => wp_kses_data( __('How many related products should be displayed in the single product page?', 'ureach') ),
					"std" => 3,
	...
	function ureach_woocommerce_theme_setup9() {
		...
		if (ureach_exists_woocommerce()) {
			...
			if ( ! function_exists( 'ureach_woocommerce_add_out_of_stock_label' ) ) {
				//Handler of the add_action( 'ureach_action_woocommerce_item_featured_link_start', 'ureach_woocommerce_add_out_of_stock_label' );
...
if ( !function_exists( 'ureach_woocommerce_post_type_taxonomy' ) ) {
	//Handler of the add_filter( 'ureach_filter_post_type_taxonomy',	'ureach_woocommerce_post_type_taxonomy', 10, 2 );
	...
	function ureach_woocommerce_add_to_cart_text($text='') {
		...
		switch ( $product_type ) {
			case 'external':
				...
				break;
			default:
				return esc_html__('add to cart', 'ureach');
		}
	}
}
