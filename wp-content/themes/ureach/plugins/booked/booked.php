...
if ( !function_exists( 'ureach_booked_tgmpa_required_plugins' ) ) {
	//Handler of the add_filter('ureach_filter_tgmpa_required_plugins',	'ureach_booked_tgmpa_required_plugins');
...
if ( !function_exists( 'ureach_booked_frontend_scripts' ) ) {
	//Handler of the add_action( 'wp_enqueue_scripts', 'ureach_booked_frontend_scripts', 1100 );
...
if ( !function_exists( 'ureach_booked_merge_styles' ) ) {
	//Handler of the add_filter('ureach_filter_merge_styles', 'ureach_booked_merge_styles');
