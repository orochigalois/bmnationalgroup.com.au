...
if ( !function_exists( 'ureach_trx_addons_merge_scripts' ) ) {
	//Handler of the add_filter('ureach_filter_merge_scripts', 'ureach_trx_addons_merge_scripts');
...
if (!function_exists('ureach_dfo')) { function ureach_dfo($obj, $level=-1) {} }
if (!function_exists('ureach_dfl')) { function ureach_dfl($msg, $level=-1) {} }
