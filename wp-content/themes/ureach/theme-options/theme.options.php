	...
	function ureach_options_create() {
		...
		ureach_storage_set('options', array(
			...
			'privacy_text' => array(
				...
				"std"   => wp_kses_post( __( 'I agree that my submitted data is being collected and stored.', 'ureach') ),
				"type"  => "text"
			),
			'author_info' => array(
			...
			'copyright' => array(
				...
				"std" => esc_html__('AncoraThemes &copy; {Y}. All rights reserved. Terms of use and Privacy Policy', 'ureach'),
				"dependency" => array(
					'footer_style' => array('footer-default')
				),
				"refresh" => false,
		...
		foreach ($theme_fonts as $tag=>$v) {
			$fonts["{$tag}_section"] = array(
				...
				"desc" => !empty($v['description']) 
								? $v['description'] 
								: wp_kses_post( sprintf(__('Font settings of the "%s" tag.', 'ureach'), $tag) ),
				"type" => "section",
				);
