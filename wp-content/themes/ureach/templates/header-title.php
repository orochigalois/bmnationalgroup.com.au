						...
						?><div class="sc_layouts_title_title"><?php
							...
							<h1 class="sc_layouts_title_caption<?php echo esc_attr($ureach_blog_title_class); ?>"><?php
								...
								if (!empty($ureach_top_icon)) {
									...
									?><img src="<?php echo esc_url($ureach_top_icon); ?>" alt="<?php esc_html_e('Icon', 'ureach')?>" <?php if (!empty($ureach_attr[3])) ureach_show_layout($ureach_attr[3]);?>><?php
								}
								echo wp_kses_post($ureach_blog_title_text);
							?></h1>
							<?php
