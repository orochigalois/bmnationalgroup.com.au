		...
		<div class="footer_logo_wrap">
			<div class="footer_logo_inner">
				...
				if (!empty($ureach_logo_image)) {
					...
					echo '<a href="'.esc_url(home_url('/')).'"><img src="'.esc_url($ureach_logo_image).'" class="logo_footer_image" alt="'. esc_html__('Logo', 'ureach') .'"'.(!empty($ureach_attr[3]) ? sprintf(' %s', $ureach_attr[3]) : '').'></a>' ;
