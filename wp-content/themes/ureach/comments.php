				...
				$ureach_comments_args = apply_filters( 'ureach_filter_comment_form_args', array(
						...
						'fields' => array(
							'author' => ureach_single_comments_field(array(
												...
												'field_name' => 'author',
												'field_title' => esc_html__('Name', 'ureach'),
												'field_placeholder' => esc_html__( 'Your Name', 'ureach' )
											)),
							'email' => ureach_single_comments_field(array(
												...
												'field_name' => 'email',
												'field_title' => esc_html__('E-mail', 'ureach'),
												'field_placeholder' => esc_html__( 'Your E-mail', 'ureach' )
											))
						),
						...
						'comment_field' => ureach_single_comments_field(array(
												...
												'field_value' => '',
												'field_name' => 'comment',
												'field_title' => esc_html__('Comment', 'ureach'),
												'field_placeholder' => esc_html__( 'Your comment', 'ureach' )
											)),
				));
