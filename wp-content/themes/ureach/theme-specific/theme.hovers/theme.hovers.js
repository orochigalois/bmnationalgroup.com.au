...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (UREACH_STORAGE['button_hover'] && UREACH_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.ureach_tabs .ureach_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				.sc_price_link:not([class*="sc_button_hover_style_"]),\
				...
				.single_post_cat .post_meta_item.post_categories> a:first-child,\
				.form-row.place-order .button.alt,\
				#buddypress a.button:not([class*="sc_button_hover_"])\
				').addClass('sc_button_hover_just_init sc_button_hover_'+UREACH_STORAGE['button_hover']);
		if (UREACH_STORAGE['button_hover']!='arrow') {
		...
		jQuery('				').addClass('sc_button_hover_just_init sc_button_hover_style_alter');
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.ureach_tabs .ureach_tabs_titles li a:not([class*="sc_button_hover_style_"])\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+UREACH_STORAGE['button_hover']);
