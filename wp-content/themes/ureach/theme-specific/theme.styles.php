...
if (!function_exists('ureach_customizer_get_css')) {

	function ureach_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = ureach_customizer_add_theme_fonts($fonts);
...
.ureach_tabs .ureach_tabs_titles li a {
...
CSS;
			$rez = apply_filters('ureach_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(ureach_get_list_schemes()) : array($only_scheme);
	
			if (is_array($schemes) && count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = ureach_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = ureach_customizer_add_theme_colors($colors);
...
h6, h6 a, [class*="color_style_"] h6 a {
...
.scheme_self.top_panel_default .top_panel_title .sc_layouts_title_caption {
	color: {$colors['bg_color']};
}
.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item a,
.scheme_self.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item a,
.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item.post_categories a,
.scheme_self.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item.post_categories a,
.top_panel_default .top_panel_title .sc_layouts_title .post_date a,
.scheme_self.top_panel_default .top_panel_title .sc_layouts_title .post_date a {
	color: {$colors['bg_color']};
}
.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item a:hover,
.scheme_self.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item a:hover,
.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item.post_categories a:hover,
.scheme_self.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item.post_categories a:hover,
.top_panel_default .top_panel_title .sc_layouts_title .post_date a:hover,
.scheme_self.top_panel_default .top_panel_title .sc_layouts_title .post_date a:hover {
	color: {$colors['text_hover']};
}
...
.ureach_tabs .ureach_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.ureach_tabs .ureach_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_hover']};
}
...
.scheme_self.footer_wrap li a, .footer_wrap .scheme_self[class*="color_style_"] li a {
    color: {$colors['text_light']};
}
...
CSS;
					...
					$rez = apply_filters('ureach_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'ureach_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>